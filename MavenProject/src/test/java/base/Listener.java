...
public class Listener implements ITestListener{
	...
	public void onTestSuccess(ITestResult result) {
		...
		Log.info(result.getMethod().getMethodName() + ": Testcase has been passed.");
	}
	...
	public void onTestFailure(ITestResult result) {
		...
		Log.info(exceptionMessage.replaceAll(",", "<br>"));
		Log.info(result.getMethod().getMethodName() + ": Testcase has been failed.");
	}
	...
	public void onTestSkipped(ITestResult result) {
		...
		Log.info(result.getMethod().getMethodName() + ": Testcase has been skipped.");
	}
